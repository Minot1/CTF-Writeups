...
And a txt file attached.

## Solution

If we put the long text from the attachment to CyberChef and use the magic tool, we get an image file from the decoded base64 and the flag is visible on the image:
